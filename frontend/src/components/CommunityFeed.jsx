    ...
    return (<section id="community" className="py-20">
       <div className="container mx-auto px-4">
         ...
         <div className="mx-auto max-w-2xl space-y-4">
           ...
           <div className="rounded-xl border border-border bg-card p-4">
             <div className="flex gap-3">
               ...
               <div className="flex-1">
                 <textarea placeholder="Share your interview experience or prep tips..." className="min-h-[80px] w-full resize-none bg-transparent text-sm placeholder:text-muted-foreground focus:outline-none"/>
           ...
           {/* Posts */}
           {mockPosts.map((post, index) => (<div key={post.id} className="animate-fade-in rounded-xl border border-border bg-card p-4 transition-colors hover:border-primary/20" style={{ animationDelay: `${index * 100}ms` }}>
                 ...
                 <div className="flex gap-3">
                   ...
                   <div>
                     <div className="flex items-center gap-1">
                       ...
                       {post.author.verified && (<Verified className="h-4 w-4 fill-primary text-primary-foreground"/>)}
                     </div>
               ...
               <div className="mb-4 flex flex-wrap gap-2">
                 {post.tags.map((tag) => (<span key={tag} className="rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-primary">
                     #{tag}
                   </span>))}
               </div>
